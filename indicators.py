...
class Indicators_AA2():
    ...
    def sum(self):
        self.grade = round(self.center_bias + self.area_ratio +
                           self.shooting_angle)
...
class Indicators_AA3():  # 指标
    ...
    def __init__(self):
        ...
        self.IMG_RATIO_ERROR = 0.1  # 比例大于此误差零分

        self.IMG_RESOLUTION_SCORE = 2
        self.IMG_RESOLUTION_SUBTRACT_START = 560 * 315  # 分辨率 小于此值开始扣分 1366*768
    ...
    def sum(self):
        self.grade = round(self.img_type + self.img_ratio +
                           self.img_resolution)
