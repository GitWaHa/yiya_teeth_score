...
PATH_MODEL_HDF5 = work_floder + "teeth_score/U_net/model_hdf5/unet_128.hdf5"

TARGET_FILL_INPUT_SIZE = (128, 128)
MODEL_FILL_INPUT_SIZE = TARGET_FILL_INPUT_SIZE + (3, )
PATH_MODEL_FILL_HDF5 = work_floder + "teeth_score/U_net/model_hdf5/unet_128_fill.hdf5"
