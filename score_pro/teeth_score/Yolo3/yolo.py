...
from teeth_score.Yolo3.model import yolo_eval, yolo_body, tiny_yolo_body
from teeth_score.Yolo3.utils import letterbox_image
import os
...
class YOLO(object):
    _defaults = {
        "model_path": work_floder + 'teeth_score/Yolo3/model_data/yolo.h5',
        "anchors_path":
