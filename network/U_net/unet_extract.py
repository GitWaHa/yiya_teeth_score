...
from network.U_net.code_python.model import *
...
PATH_MODEL_HDF5 = os.path.join(work_floder, "mode/unet/unet_128.hdf5")

TARGET_FILL_INPUT_SIZE = (128, 128)
MODEL_FILL_INPUT_SIZE = TARGET_FILL_INPUT_SIZE + (3, )
PATH_MODEL_FILL_HDF5 = work_floder + "mode/unet/unet_128_fill.hdf5"
